...
@class XMFilmModel; @class XMDanmuModel; @class XMTaskViewController; @class KLCPopup; @class BarrageCanvas; @class ZFPortraitControlView; @class AppDelegate; @class XMFilemListHeaderView; @class XMADSView; @class ZFLandScapeControlView; @class XMFilmDetailController; @class XMUser; @class XMsetModel; 
