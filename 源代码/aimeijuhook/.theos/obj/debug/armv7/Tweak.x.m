...
@class BarrageCanvas; @class XMFilmDetailController; @class XMFilemListHeaderView; @class XMsetModel; @class ZFLandScapeControlView; @class ZFPortraitControlView; @class XMUser; @class XMFilmModel; @class XMTaskViewController; @class KLCPopup; @class AppDelegate; @class XMDanmuModel; @class XMADSView; 
